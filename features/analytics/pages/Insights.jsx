...
const Insights = () => {
  return (
    <PageWrapper
      ...
      description="View advanced analytical data and performance metrics."
    >
      <motion.div
      ...
      >
        ...
        >
          <div className="flex gap-6 mb-6">
            {[BarChart2, TrendingUp, PieChart].map((Icon, i) => (
              <motion.div
                key={i}
                animate={{ y: [0, -8, 0] }}
                transition={{
          ...
          <p className="text-[var(--titan-text-muted)] text-sm text-center max-w-sm">
            Advanced analytical data and performance metrics will appear here.
          </p>
          <motion.div
